    ...
    public partial class MainWindow : Window
    {
        ...
        void addElement()
        {
            ...
            root.Add(new XElement("Entry",
                new XElement("StartDate", Dt[0]),
                new XElement("FinishDate", Dt[1]),
                new XElement("Hours", Math.Round(((Dt[1] - Dt[0]).TotalHours), 2)
                )));
            saveXmlFile();
            refreshShowBox();
        }
        ...
        void initMonthCombobox()
        {
            ...
            refreshShowBox();
            showTextBox.HorizontalScrollBarVisibility = System.Windows.Controls.ScrollBarVisibility.Visible;
        }
        void refreshShowBox()
        {
            showTextBox.Text = DatabaseToString(monthComboBox.SelectedIndex);
